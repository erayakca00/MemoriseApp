        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TurWordName = table.Column<string>(type: "character varying(150)", maxLength: 150, nullable: false),
                    PicturePath = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    SoundPath = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<string>(type: "text", nullable: false),
                    WordID = table.Column<int>(type: "integer", nullable: false),
                    RepetitionLevel = table.Column<int>(type: "integer", nullable: false),
                    ConsecutiveCorrectAnswers = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    WordSampleID = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    WordID = table.Column<int>(type: "integer", nullable: false),
                    SampleSentence = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WordSamples_WordID_SampleSentence",
                table: "WordSamples",
                columns: new[] { "WordID", "SampleSentence" },
                unique: true);
        }
